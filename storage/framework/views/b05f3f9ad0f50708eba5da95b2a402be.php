...
<?php $__env->startSection('title', 'Bienvenido a School Platform'); ?>
    ...
    <div class="container mx-auto px-4 py-12">
        ...
        <div class="grid md:grid-cols-2 gap-12 items-center">
            <div class="space-y-6">
                ...
                <a href="<?php echo e(route('projects.create')); ?>" class="inline-block bg-blue-500 text-white py-2 px-6 rounded-lg hover:bg-blue-600 transition duration-300 ease-in-out">Comienza tu primer proyecto</a>
            </div>
        ...
        <div class="mt-16 text-center">
            ...
            <a href="<?php echo e(route('register')); ?>" class="inline-block bg-blue-500 text-white py-3 px-8 rounded-lg hover:bg-blue-600 transition duration-300 ease-in-out text-lg font-semibold">Regístrate ahora</a>
            <p class="mt-4 text-gray-600">¿Ya tienes una cuenta? <a href="<?php echo e(route('login')); ?>" class="text-blue-500 hover:underline">Inicia sesión aquí</a></p>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\School_Platform\resources\views/inicio.blade.php ENDPATH**/ ?>