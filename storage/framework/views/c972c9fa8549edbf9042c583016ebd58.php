    ...
    <nav class="bg-blue-600 text-white shadow-lg">
        <div class="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <ul class="flex space-x-6">
                ...
                <li><a href="<?php echo e(route('projects.index')); ?>"
                ...
                <?php else: ?>
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="hover:text-blue-200 transition duration-150 ease-in-out">
                        Iniciar Sesión
                    </a>
                <?php endif; ?>
...
<?php /**PATH C:\laragon\www\School_Platform\resources\views/layouts/app.blade.php ENDPATH**/ ?>